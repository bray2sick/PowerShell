...
.DESCRIPTION
    This script prompts the user to enter the first name and last name of the user account they want to enable. It then checks if the user exists in Active Directory and enables the account if it does. If the user does not exist, an error message is displayed.

.EXAMPLE
    PS C:\> .\ActiveDirectory\Enable-UserAccount.ps1
